...
const MAP = {
  ...
  vial: 'test-tube', vibrate: 'vibrate', 'volume-high': 'volume-2', 'volume-up': 'volume-2', 'vote-yea': 'vote',
...
function build() {
  ...
  // Font Awesome draws a starred item with the solid star and an unstarred one
  // with the regular (outline) star.
  rules.push(`.fas.fa-star{--icon:${dataUri(svgFor('star', true))}}`);
